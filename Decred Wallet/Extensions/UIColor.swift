...
extension UIColor {
    struct appColors {
        ...
        static let _lightGray = UIColor.init(hex: "#DEE1E3") // temporary name, pending when it will be made obsolete and removed
        ...
        static let lightDecredGreen = UIColor.init(hex: "#C4ECCA")
        static let turquoise = UIColor.init(hex: "#2DD8A3")
        static let darkTurquoise = UIColor.init(hex: "#14A078")
        
        static let errorOrange = UIColor.init(hex: "#ED6D47")
        static let lightOrange = UIColor.init(hex: "#FEB8A5")
        
        static let warningYellow = UIColor.init(hex: "#FFC84E")
