...
extension UIButton {
    ...
    func addBorders(atPositions borderPositions: [BorderPosition], color: UIColor = UIColor.appColors.darkerGray, thickness: CGFloat = 1.7) {
        borderPositions.forEach({ borderPosition in
            self.addBorder(atPosition: borderPosition, color: color, thickness: thickness)
        })
    }
    
    func addBorder(atPosition borderPosition: BorderPosition, color: UIColor = UIColor.appColors.darkerGray, thickness: CGFloat = 1.7) {
