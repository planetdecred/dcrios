...
class RequestPinViewController: SecurityBaseViewController {
    ...
    override func viewDidLoad() {
        if self.requestPinConfirmation {
            self.headerText.text = String(format: "createPIN".localized, self.securityFor)
        } else {
            self.headerText.text = String(format: "enterPIN".localized, self.securityFor)
    ...
    @IBAction func onOkButtonTapped(_ send: Any) {
        ...
        if self.requestPinConfirmation && pinToConfirm == "" {
            ...
            self.headerText.text = String(format: "confirmPIN".localized, self.securityFor)
            ...
            self.pinToConfirm = ""
            self.headerText.text = "pinsDidNotMatch".localized
