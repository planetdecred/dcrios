...
struct LocalizedStrings {
    ...
    static let changedAccount = NSLocalizedString("changedAccount", comment: "")
    static let accountBranch = NSLocalizedString("accountBranch", comment: "")
    static let shuffleSever = NSLocalizedString("shuffleSever", comment: "")
    static let shufflePort = NSLocalizedString("shufflePort", comment: "")
    static let dangerZone = NSLocalizedString("dangerZone", comment: "")
