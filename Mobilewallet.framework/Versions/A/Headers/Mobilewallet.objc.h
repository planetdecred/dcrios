...
- (MobilewalletConstructTxResponse*)constructTransaction:(NSString*)destAddr amount:(int64_t)amount srcAccount:(int32_t)srcAccount requiredConfirmations:(int32_t)requiredConfirmations sendAll:(BOOL)sendAll error:(NSError**)error;
