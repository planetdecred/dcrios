...
/*protocol DcrSendTransactionProtocol: DcrdBaseProtocol{
    func prepareTransaction(from account:Int32, to address:String, amount:Double, isSendAll: Bool?) throws -> MobilewalletUnsignedTransaction?
    func signTransaction(transaction: MobilewalletUnsignedTransaction, password:Data) throws -> Data?
...
extension DcrSendTransactionProtocol{
    ...
    func sendTransaction(transaction: MobilewalletUnsignedTransaction, password:Data,desAddress:String,Amount:Int64,srcAccount:Int32,isSendAll: Bool?) throws -> Data?  {
        let isShouldBeConfirmed = UserDefaults.standard.bool(forKey: "pref_spend_fund_switch")
